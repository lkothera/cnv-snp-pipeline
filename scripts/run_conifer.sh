...
conifer.py plotcalls --input ${BASE}/pipeline-runs/${RUN_NAME}/conifer/analysis.hdf5 --calls ${BASE}/pipeline-runs/${RUN_NAME}/conifer/cnv_calls.txt --outputdir ${BASE}/pipeline-runs/${RUN_NAME}/conifer/call_imgs/

# -- export calls
mkdir -p ${BASE}/pipeline-runs/${RUN_NAME}/conifer/export
conifer.py export --input ${BASE}/pipeline-runs/${RUN_NAME}/conifer/analysis.hdf5 --output ${BASE}/pipeline-runs/${RUN_NAME}/conifer/export/
