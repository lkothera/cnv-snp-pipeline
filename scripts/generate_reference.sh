...
${BASE}/scripts/generate_single_contig2.py --in_fasta ${BASE_REFERENCE}/bwa/supercontigs.fa --out_fasta ${BASE_REFERENCE}/bwa/supercontigs_combined.fa --in_probe ${BASE_REFERENCE}/probes_full_step2.txt --out_probe ${BASE_REFERENCE}/probes_final.txt --out_gene ${BASE_REFERENCE}/gene_coords.txt --out_gtf ${BASE_REFERENCE}/${REFERENCE}-combined.gtf
